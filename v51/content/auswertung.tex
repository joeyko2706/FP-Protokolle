...
\begin{aquation}
    \ln{f_\text{Grenz}} &= \frac{b-b^\prime}{a^\prime-a}
\end{aquation}
...
\end{figure}
Eine grafische Darstellung der Integrations- und Differentiationsfunktion ist in \autoref{fig:integrator_differentiator} zu finden.
\begin{figure}
    \centering
...
\begin{aquation}
    \eta &= 30.89 \pm 0.10 \tp
\end{aquation}
Die Zerfallskonstante lässt sich unter Verwendung einer zu \autoref{eq:fehler} analogen Fehlerformel bestimmen zu 
\begin{aquation}
    \tau &= (64.73 \pm 2.01) \text{ms}\tp
\end{aquation}
